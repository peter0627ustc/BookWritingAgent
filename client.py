...
- If the subsection introduces new concepts or new methods, provide some exercise and solutions for the readers.
...
# if possible, please propose the relevant problems you have searched for this topic and provide the specific content of the problems, but ensure the content is valid and contains the key words first.
...
async def generate_section_with_content(topic, style_guide=None, language="zh-CN", mode="advanced", output_file="generated_section.md"):
    """
...
def generate_book_section(subchapter_code, content_file="content.txt", language="zh-CN", mode="advanced", output_dir=".", physics_insight="Simple and wonderful, profound and expansive"):
    """
